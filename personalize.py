...
"""
    ...
    Creates a personally named version of visualtitle.
...
FILES_TO_DELETE = [
    ".git",
    "README.rst",
    "visualtitle.egg-info",
    "visualtitle/templates/helloworld.pt",
    "visualtitle/templates/myfooter.pt",
    "visualtitle/templates/plone.app.layout.viewlets.logo.pt",
    "visualtitle/static/pony.png"
]
...
def process(fname, newname):
    ...
    if filepart == TEMPLATE_NAME:
        # Rename visualtitle folders to something else
